...
public class MainActivityP23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_p23);
        tabLayout=(TabLayout)findViewById(R.id.tablayoutP23);
        viewPager=(ViewPager) findViewById(R.id.viewPagerP23);
        adapter=new ViewPagerAdapter(getSupportFragmentManager());

        adapter.AddFragment(new FragmentMathsP23(),"Mathematics(1-10)");
