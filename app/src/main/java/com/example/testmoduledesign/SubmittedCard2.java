...
public class SubmittedCard2 {
    String javaText, mathsText, phyTest, chemTest;
    String qsns, min, marks, recentText;

    public SubmittedCard2(String javaText, String mathsText, String phyTest, String chemTest, String qsns, String min, String marks, String recentText) {
