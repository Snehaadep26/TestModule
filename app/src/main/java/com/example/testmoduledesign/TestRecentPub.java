...
public class TestRecentPub {

    String javaText, mathsText, phyTest, chemTest;
    String qsns, min, marks, recentText;

    public TestRecentPub(String javaText, String mathsText, String phyTest, String chemTest, String qsns, String min, String marks, String recentText) {
