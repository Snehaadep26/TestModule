...
public class AvailableCard2 {
    String javaText, mathsText, dateText, timeText,chemText,phyText;
    String qsns, min, marks;

    public AvailableCard2(String javaText, String mathsText, String dateText, String timeText, String chemText, String phyText, String qsns, String min, String marks) {
